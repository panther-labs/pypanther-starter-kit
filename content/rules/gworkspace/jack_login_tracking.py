    ...
    tests = [
        RuleTest(
            ...
            log={
                ...
                "parameters": {"login_type": "normal", "browser": "Chrome", "device_type": "desktop"},
                "ipAddress": "192.0.2.1",
                "name": "login_success",
            },
        ),
        RuleTest(
            ...
            log={
                "id": {"applicationName": "login"},
                "actor": {"email": "jack@test.com"},
                "parameters": {"login_type": "reauth", "browser": "Chrome", "device_type": "desktop"},
                "ipAddress": "192.0.2.1",
                "name": "login_reauth",
            },
        ),
        RuleTest(
            ...
            log={
                ...
                "actor": {"email": "jack@test.com"},
                "parameters": {"browser": "Chrome", "device_type": "desktop"},
                "ipAddress": "192.0.2.1",
                "name": "file_access",
            },
        ),
